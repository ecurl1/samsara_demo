...
import json
from src.visualization_helpers import load_data, plot_timeseries
...
def index():
    ...
    return render_template('index.html', plot_json_temp=plot_json_temp, plot_json_door=plot_json_door)
